...
# Examples
An Click counting example is in the [examples directory](examples/ClickCounter.hs). NOTE: The `todo` example is under construction (requires me to write some more in-built widgets).
